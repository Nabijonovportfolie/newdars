                            ...
                            <div class="modal-body">
                                <form action="/lessonSave" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="name" placeholder="Nomini kiriting..." required>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Title</label>
                                        <input type="text" class="form-control" name="title" placeholder="Title kiriting..." required>
                                    </div>
                                    <div class="mb-3">
                    ...
                    <button class="btn btn-primary">Edit</button>
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="/delete/{{$les->id}}" class="btn btn-primary">Xa</a>
                            </div>
                            </div>
                        </div>
                        </div>
