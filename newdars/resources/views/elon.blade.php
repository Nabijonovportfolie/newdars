    ...
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="\home" class="site_title"><i class="fa fa-paw"></i> <span>Begzod Nabijonov</span></a>
            </div>
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                  <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="admin/production/images/img.jpg" alt="">Begzod Nabijonov
                  </a>
        ...
        <div class="card-header">
                    <button style="margin: left 500px;" class="btn btn--add btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fa fa-x fa-plus"></i> Ma'lumot qo'shish</button>
                </div>
                            ...
                            <div class="modal-body">
                                <form action="/elonSave" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="name" placeholder="Ismingizni kiriting..." required>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="news" placeholder="News kiriting..." required>
                                    </div>
                                    <div class="mb-3">
                    ...
                    <button class="btn btn-primary">Edit</button>
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="/delete/{{$se->id}}" class="btn btn-primary">Xa</a>
                            </div>
                            </div>
                        </div>
                        </div>
