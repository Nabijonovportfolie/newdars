...
class HomeController extends Controller
{
    ...
    public function elonSave(Request $request) {
        //dd($request);.
        $get = new Elon();
        $get->name = $request->name;
    ...
    public function malumotSave(Request $request) {
        $get = new Maktab();
        $get->name = $request->name;
    ...
    public function kursSave(Request $request) {
        $get = new Kurs();
        $get->name = $request->name;
        $get->title = $request->title;
    ...
    public function yangilikSave(Request $request) {
        $get = new Yangilik();
        $get->name = $request->name;
        $get->title = $request->title;
