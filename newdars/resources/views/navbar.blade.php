      ...
      <div class="main_container">
        ...
        <div class="card-header">
          <button style="margin: left 500px;" class="btn btn--add btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="fa fa-x fa-plus"></i> Ma'lumot qo'shish</button>
                    <!-- <button type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-success">Qo'shish</button> -->
                </div>
                            ...
                            <div class="modal-body">
                                <form action="/navbarSave" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="name" placeholder="Navbar kiriting..." required>
                                    </div>
